...
public class InteropScenarioClient {
    ...
    public void invokeWithStaticConfig(String clientRepo, String url)
            throws Exception {
	FileOutputStream fo = new FileOutputStream(new File("/home/muthulee/test.txt"));
        fo.write("Me here".getBytes());
fo.flush();
	fo.close();
